...
def transfer_data(**context):
    try:
        ...
        while True:
            ...
            try:
                ...
                if offset == chunk_size:
                    truncate_query = "TRUNCATE TABLE warehouse_dev.BIN_table;"
        ...
        params = ('BIN_table', start_date_time, end_date_time, total_rows, last_day_rows, status)
...
dag = DAG(
    ...
    description='Transfer BIN data from MySQL to PostgreSQL daily in chunks with ETL tracking',
    schedule_interval='10 10 * * *',  # Daily at 10:10 AM
    catchup=False,
)

# Define the PythonOperator
transfer_task = PythonOperator(
    task_id='transfer_tab_BIN_data_task',
