...
def transfer_data(**context):
    try:
        ...
        while True:
            ...
            try:
                ...
                if offset == chunk_size:
                    truncate_query = "TRUNCATE TABLE warehouse_dev.tag_link_table;"
                ...
                postgres_hook.insert_rows(
                    table='warehouse_dev.tag_link_table',
        ...
        params = ('tag_link_table', start_date_time, end_date_time, total_rows, last_day_rows, status)
...
dag = DAG(
    'tab_Tag_Link_Table_ETL',
    default_args=default_args,
    description='Transfer tag link data from MySQL to PostgreSQL daily in chunks with ETL tracking',
    schedule_interval='20 10 * * *',  # Daily at 10:20 AM
    catchup=False,
)

# Define the PythonOperator
transfer_task = PythonOperator(
    task_id='transfer_tab_Tag_Link_data_task',
