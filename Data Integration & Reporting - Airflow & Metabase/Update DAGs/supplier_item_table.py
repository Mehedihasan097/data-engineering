    ...
    try:
        ...
        while True:
            ...
            SELECT 
                ...
                ifw_supplier_qoh,
                ifw_sqohtimestamp
            from erpnext_prod.`tabItem Supplier`
            ...
            try:
                ...
                if offset == chunk_size:
                    truncate_query = "TRUNCATE TABLE warehouse_dev.supplier_item_table;"
                ...
                postgres_hook.insert_rows(
                    table='warehouse_dev.supplier_item_table',
        ...
        params = ('supplier_item_table', start_date_time, end_date_time, total_rows, last_day_rows, status)
...
dag = DAG(
    'tab_Supplier_Item_Table_ETL',
    default_args=default_args,
    description='Transfer supplier item data from MySQL to PostgreSQL daily in chunks with ETL tracking',
...
transfer_task = PythonOperator(
    task_id='transfer_tab_supplier_item_data_task',
